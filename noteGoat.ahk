...
global noteTypedInfo := ["start keybind, end keybind, delete last key bool, input timeout, typing sleep", "\","\", True, "8", 900]
global operators := ["selected keybind, toggle slideout keybind", "^Insert", "Insert", "^!j"]
global jwClick := ["jw click", True,  17, 236, 500]
global wolClick := ["wol click", True, 22, 288, 0]
global iconClick := ["wol icon", True, 76, 166, 1000]
global searchClick := ["search bar", True, 631, 162, 500]
global scriptureClick := ["scripture", True, 161, 399, 1000]
...
;update settings operators
Hotkey, % operators[4], updates, On
